...
export const UPDATE_CLASS_STUDENT_VALUES = 'UPDATE_CLASS_STUDENT_VALUES';
export const RESET_DEFAULTS_TEACHER = 'RESET_DEFAULTS_TEACHER';
export const SET_ACTIVE_CLASS_STUDENT_VALUE_INDEX = 'SET_ACTIVE_CLASS_STUDENT_VALUE_INDEX';
